...
function App() {
    ...
    function worlesDeliveryDate(EntOrd,Datos){
    ...
    function exportToExcel() {
        ...
        sortedData.forEach((item) => {
            worksheet.addRow([
                ...
                item.Observaciones,
                item.Location,
                formatDate(worlesDeliveryDate(item.EntOrd,item.Datos))
            ]);
        });
                    ...
                    <div className="flex items-center justify-center gap-3 ml-5">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 text-sm font-semibold border-2 border-blue-800 rounded-md text-gray-700 bg-gray-200 hover:bg-blue-800 hover:text-white ${
                                location === 7 ? "bg-blue-800 text-white" : ""
                            }`}
                        >
                            AWT
                        </button>
            ...
            <div className="w-full h-full">
                ...
                >
                    ...
                    {loading || filteredData.length === 0 ? (
                        <tbody>
                            <tr>
                                <td className="text-center text-xl border-none  absolute top-[200px] left-[570px]">
                                    No data found
                                </td>
                            </tr>
                        </tbody>
